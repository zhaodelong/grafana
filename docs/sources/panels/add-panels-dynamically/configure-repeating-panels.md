+++
aliases = ["/docs/sources/panels/add-panels-dynamically/configure-repeating-panels/", "/docs/grafana/latest/panels/add-panels-dynamically/configure-repeating-panels"]
