+++
aliases = ["/docs/grafana/latest/alerting/unified-alerting/high-availability/", "/docs/grafana/latest/alerting/unified-alerting/high-availability/enable-alerting-ha"]
